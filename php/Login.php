<?php
    ...
    if(isset($_POST['submit_button'])){
    	...
    	if ($username != "" && $password != ""){
    		$sql_query = "SELECT count(*) as 'cntUser','user id' from 'user information' where 'Username'='".$username."' and 'Password' = '".$password."'"; //prep SQL for USER and PASS
    		$result = mysqli_query($conn, $sql_query); //check
    		$row = mysqli_fetch_array($result); //found?
